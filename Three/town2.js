...
var buildingGeometry1 = new THREE.BoxGeometry(40, 30, 40);
var buildingGeometry2 = new THREE.BoxGeometry(20, 30, 20);
...
function spawnBuilding1(x, z) {
	building = new THREE.Mesh(buildingGeometry1.clone(), materialLambertBlue);
...
function spawnBuilding2(x, z) {
	building = new THREE.Mesh(buildingGeometry2.clone(), materialLambertBlue);
	roof = new THREE.Mesh(roofGeometry.clone(), materialLambertBrown);
